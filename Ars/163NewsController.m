...
#import "163NewsController.h"

@interface _63NewsController ()

@end

@implementation _63NewsController{
    UIWebView *webview;
}
...
- (void)viewDidLoad {
    ...
    [webview loadRequest:[[NSURLRequest alloc] initWithURL:[NSURL URLWithString:@"http://sports.163.com/world/"]]];
    // 添加下拉刷新控件
